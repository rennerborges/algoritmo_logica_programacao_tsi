...
int main()
{
    ...
    // Vamos abrir/criar o arquivo, sempre lembrando que o 'w' dá tipo um restart no arquivo
    // se ele já existir, caso contrário o arquivo será criado.
    ...
    if (arquivo == NULL)
    {
        ...
        printf(ANSI_COLOR_RED "Não foi possivel criar o arquivo!" ANSI_COLOR_RESET);
        exit(1);
    }
